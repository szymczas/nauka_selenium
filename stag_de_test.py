...
driver.find_element_by_css_selector('[data-test-id="FIRST_NAME"]').send_keys("mojastara")
driver.find_element_by_css_selector('[data-test-id="LAST_NAME"]').send_keys("twojastara")
